...
(function (root, factory) {
  ...
  Blockly.JavaScript.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = Blockly.utils.string.wrap(e, this.COMMENT_WRAP - 3)),
        (d += this.prefixLines(e + "\n", "// ")));
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type == Blockly.inputTypes.VALUE &&
  ...
  Blockly.JavaScript.getAdjusted = function (a, b, c, d, e) {
    ...
    a =
      0 < c
        ? this.valueToCode(a, b, this.ORDER_ADDITION) || f
        : 0 > c
        ? this.valueToCode(a, b, this.ORDER_SUBTRACTION) || f
        : d
        ? this.valueToCode(a, b, this.ORDER_UNARY_NEGATION) || f
        : this.valueToCode(a, b, e) || f;
    if (Blockly.isNumber(a)) (a = Number(a) + c), d && (a = -a);
      ...
      d &&
        ((a = c ? "-(" + a + ")" : "-" + a), (g = this.ORDER_UNARY_NEGATION));
      g = Math.floor(g);
      e = Math.floor(e);
      g && e >= g && (a = "(" + a + ")");
    }
  ...
  Blockly.JavaScript.lists_setIndex = function (a) {
    function b() {
      if (c.match(/^\w+$/)) return "";
      var g = Blockly.JavaScript.nameDB_.getDistinctName(
          "tmpList",
    ...
    switch (e) {
      ...
      case "RANDOM":
        a = b();
        e = Blockly.JavaScript.nameDB_.getDistinctName(
          "tmpX",
          Blockly.VARIABLE_CATEGORY_NAME
        );
  ...
  Blockly.JavaScript.controls_repeat_ext = function (a) {
    ...
    a = "";
    var d = Blockly.JavaScript.nameDB_.getDistinctName(
        "count",
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      e = b;
  ...
  Blockly.JavaScript.controls_for = function (a) {
    var b = Blockly.JavaScript.nameDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      c =
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
      ...
      (a = ""),
        ...
        c.match(/^\w+$/) ||
          Blockly.isNumber(c) ||
          ((g = Blockly.JavaScript.nameDB_.getDistinctName(
            b + "_start",
            Blockly.VARIABLE_CATEGORY_NAME
          )),
          (a += "var " + g + " = " + c + ";\n")),
        ...
        d.match(/^\w+$/) ||
          Blockly.isNumber(d) ||
          ((c = Blockly.JavaScript.nameDB_.getDistinctName(
            b + "_end",
            Blockly.VARIABLE_CATEGORY_NAME
          )),
          (a += "var " + c + " = " + d + ";\n")),
        (d = Blockly.JavaScript.nameDB_.getDistinctName(
          b + "_inc",
          Blockly.VARIABLE_CATEGORY_NAME
        )),
        (a += "var " + d + " = "),
  ...
  Blockly.JavaScript.math_change = function (a) {
    ...
    a = Blockly.JavaScript.nameDB_.getName(
      a.getFieldValue("VAR"),
      Blockly.VARIABLE_CATEGORY_NAME
    );
    return (
  ...
  Blockly.JavaScript.procedures_defreturn = function (a) {
    ...
    for (var h = [], l = a.getVars(), k = 0; k < l.length; k++)
      h[k] = Blockly.JavaScript.nameDB_.getName(
        l[k],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    c =
